...
timeFrom y (Just m) (Just d) (Just c)       = Right $ K.timeSetClock c $ K.timeFromYmd y m d
timeFrom y (Just m) (Just d) (Nothing)      = Right $ K.timeFromYmd y m d
timeFrom y (Just m) (Nothing) (Nothing)     = K.timeFromYmAb y m
