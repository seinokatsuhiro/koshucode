...
relTable :: (D.CRel c, B.MixEncode c) => [S.ShortDef] -> D.Rel c -> String
relTable sh = unlines . relTableLines sh

-- | Render relation in table layout.
relTableLines :: (D.CRel c, B.MixEncode c) => [S.ShortDef] -> D.Rel c -> [String]
...
relText :: (D.CRel c, B.MixEncode c) => [S.ShortDef] -> D.Rel c -> D.RelText
