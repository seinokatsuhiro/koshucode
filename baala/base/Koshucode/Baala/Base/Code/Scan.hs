...
--
codeScanUp :: (B.ToLines i, O.Textual t) => CodeScanMap k t -> B.IxIOPoint -> i -> [B.CodeLine k t]
codeScanUp f ixio = codeScanUpLines f ixio . zip [1 ..] . B.toLines

codeScanUpLines :: (O.Textual t) => CodeScanMap k t -> B.IxIOPoint -> [(B.LineNumber, t)] -> [B.CodeLine k t]
