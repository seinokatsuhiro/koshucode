...
|-- DIR-RANK  /dir-rank 3  /dir "Koshucode.Baala.Base.List"  /base-rank {= /rank /base /import-dir [ 0 | "Split" | [ ] ]
    [ 1 | "Assoc" | [ ] ] [ 1 | "List" | [ ] ] [ 1 | "Select" | [ ] ] [ 1 | "Set" | [ ] ] [ 3 | "Order" | [ "Prelude" ]
    ] =}
...
|-- DIR-RANK  /dir-rank 11  /dir "Koshucode.Baala.Base.IO"  /base-rank {= /rank /base /import-dir [ 3 | "Encoding" | [
    ...
    | "Prelude" ] ] =}
|-- DIR-RANK  /dir-rank 14  /dir "Koshucode.Baala.Base.Code"  /base-rank {= /rank /base /import-dir [ 11 | "Message" | [
    "Abort" ] ] [ 12 | "Tree" | [ "Abort" | "List" | "Prelude" ] ] [ 13 | "Infix" | [ "Prelude" ] ] [ 13 | "Line" | [
    "Abort" | "IO" | "Prelude" ] ] [ 14 | "Clause" | [ "Abort" | "List" | "Prelude" ] ] [ 14 | "Scan" | [ "Abort" | "IO"
    | "Prelude" ] ] =}
|-- DIR-RANK  /dir-rank 15  /dir "Koshucode.Baala.Base"  /base-rank {= /rank /base /import-dir [ 2 | "Prelude" | [ ] ] [
    4 | "List" | [ ] ] [ 4 | "MixText" | [ ] ] [ 6 | "Text" | [ ] ] [ 10 | "Abort" | [ ] ] [ 12 | "IO" | [ ] ] [ 12 |
    "Message" | [ ] ] [ 15 | "Code" | [ ] ] =}
...
TABLE : DIR-RANK
  ...
  11        "Koshucode.Baala.Base.IO"        /rank /base         /import-dir
                                             ----- ------------- -----------------------------------------------------------------------
                                             3     "Encoding"    [ "Prelude" ]
                                             3     "Http"        [ "Prelude" ]
                                             5     "IOPoint"     [ "List" | "Prelude" ]
                                             11    "BzFile"      [ "Abort" | "Prelude" ]
                                             
  14        "Koshucode.Baala.Base.Code"      /rank /base         /import-dir
                                             ----- ------------- -----------------------------------------------------------------------
                                             11    "Message"     [ "Abort" ]
                                             12    "Tree"        [ "Abort" | "List" | "Prelude" ]
                                             13    "Infix"       [ "Prelude" ]
                                             13    "Line"        [ "Abort" | "IO" | "Prelude" ]
                                             14    "Clause"      [ "Abort" | "List" | "Prelude" ]
                                             14    "Scan"        [ "Abort" | "IO" | "Prelude" ]
...
|-- DIR-RANK  /dir-rank 17  /dir "Koshucode.Baala.Syntax.Attr"  /base-rank {= /rank /base /import-dir [ 0 | "AttrName" |
    [ ] ] [ 6 | "Message" | [ "Para" | "Symbol" ] ] [ 16 | "Attr" | [ "Para" | "TTree" ] ] [ 16 | "Slot" | [ "TTree" |
    "Token" ] ] [ 17 | "AttrEd" | [ "Symbol" | "TTree" | "Token" ] ] =}
|-- DIR-RANK  /dir-rank 18  /dir "Koshucode.Baala.Syntax"  /base-rank {= /rank /base /import-dir [ 4 | "Para" | [ ] ] [
    5 | "Symbol" | [ ] ] [ 7 | "Message" | [ ] ] [ 11 | "Token" | [ ] ] [ 14 | "Pattern" | [ ] ] [ 15 | "TTree" | [ ] ]
    [ 18 | "Attr" | [ ] ] =}
|-- DIR-RANK  /dir-rank 19  /dir "Koshucode.Baala"  /base-rank {= /rank /base /import-dir [ 0 | "Base" | [ ] ] [ 0 |
    "Overture" | [ ] ] [ 19 | "Syntax" | [ "Attr" | "Para" | "Symbol" | "TTree" | "Token" ] ] =}
...
|-- DIR-RANK  /dir-rank 0  /dir "Koshucode.Baala.Syntax"  /base-rank {= /rank /base /import-dir [ 0 | "Pattern" | [ ] ]
    =}
|-- DIR-RANK  /dir-rank 4  /dir "Koshucode.Baala.Rop.Base"  /base-rank {= /rank /base /import-dir [ 1 | "Define" | [ ] ]
    [ 1 | "Message" | [ ] ] [ 2 | "Get" | [ ] ] [ 2 | "Rop" | [ ] ] [ 3 | "Rel" | [ ] ] [ 4 | "Cox" | [ ] ] =}

|-- DIR-RANK  /dir-rank 8  /dir "Koshucode.Baala.Rop.Flat.Lattice"  /base-rank {= /rank /base /import-dir [ 6 |
    "Tropashko" | [ "Base" ] ] [ 7 | "Restrict" | [ "Base" ] ] [ 8 | "Rop" | [ "Base" ] ] =}
|-- DIR-RANK  /dir-rank 11  /dir "Koshucode.Baala.Rop.Flat"  /base-rank {= /rank /base /import-dir [ 1 | "PoScale" | [ ]
    ] [ 2 | "Message" | [ ] ] [ 6 | "Elem" | [ "Base" ] ] [ 6 | "Meta" | [ "Base" ] ] [ 6 | "Order" | [ "Base" ] ] [ 6 |
    "Resource" | [ "Base" ] ] [ 6 | "Source" | [ "Base" ] ] [ 6 | "Subtext" | [ "Base" ] ] [ 6 | "Term" | [ "Base" ] ] [
    7 | "Gadget" | [ "Base" ] ] [ 7 | "Peripheral" | [ "Base" ] ] [ 7 | "TermGadget" | [ "Base" ] ] [ 9 | "Lattice" | [
    ] ] [ 10 | "Check" | [ "Base" | "Lattice" ] ] [ 10 | "Control" | [ "Base" | "Lattice" ] ] [ 11 | "Bundle" | [ "Base"
    | "Lattice" ] ] =}
|-- DIR-RANK  /dir-rank 12  /dir "Koshucode.Baala.Rop"  /base-rank {= /rank /base /import-dir [ 5 | "Base" | [ ] ] [ 12
    | "Flat" | [ "Lattice" ] ] =}
...
TABLE : DIR-RANK
  ...
  4         "Koshucode.Baala.Rop.Base"           /rank /base          /import-dir
                                                 ----- -------------- ------------------------
                                                 1     "Define"       [ ]
                                                 1     "Message"      [ ]
                                                 2     "Get"          [ ]
  ...
  8         "Koshucode.Baala.Rop.Flat.Lattice"   /rank /base          /import-dir
                                                 ----- -------------- ------------------------
                                                 6     "Tropashko"    [ "Base" ]
                                                 7     "Restrict"     [ "Base" ]
                                                 8     "Rop"          [ "Base" ]
                                                 
  11        "Koshucode.Baala.Rop.Flat"           /rank /base          /import-dir
                                                 ----- -------------- ------------------------
                                                 1     "PoScale"      [ ]
                                                 2     "Message"      [ ]
                                                 6     "Elem"         [ "Base" ]
                                                 ...
                                                 7     "TermGadget"   [ "Base" ]
                                                 9     "Lattice"      [ ]
                                                 10    "Check"        [ "Base" | "Lattice" ]
                                                 10    "Control"      [ "Base" | "Lattice" ]
                                                 11    "Bundle"       [ "Base" | "Lattice" ]
                                                 
  12        "Koshucode.Baala.Rop"                /rank /base          /import-dir
                                                 ----- -------------- ------------------------
                                                 5     "Base"         [ ]
                                                 12    "Flat"         [ "Lattice" ]
